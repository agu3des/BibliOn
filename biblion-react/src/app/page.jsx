    ...
    <>
      ...
      <main>
        <div className="lg:max-w-screen-lg mx-auto">
          <div className="books grid grid-cols-3 gap-6" />
          {books.map((book) => (
              <BooksCards {...book} key={book.id} />
            ))}
        </div>
      </main>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-3 text-sm text-xl uppercase dark:text-white">
                  Indique-nos um livro:
                </h2>
                <ul className="text-xl dark:text-gray-400 font-medium">
                  <li className="mb-2">
                    <a
                      href="indicacoes.html"
              ...
              <div>
                <h2 className="mb-4 text-sm text-xl uppercase dark:text-white">
                  Follow us
                </h2>
                <ul className="text-xl dark:text-gray-400">
                  <li className="mb-2">
                    <a
                      href="mailto:biblion@gmail.com"
                      className="hover:underline hover:text-pink-500"
                    >
                      Email
                    </a>
                  ...
                  <li className="mb-2">
                    <a
                      href="https://www.instagram.com/biblion/"
                      className="hover:underline hover:text-pink-500"
                    >
                      Instagram
                    </a>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" className="hover:text-pink-500 dark:hover:text-white">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                href="#"
                className="hover:text-pink-500 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
